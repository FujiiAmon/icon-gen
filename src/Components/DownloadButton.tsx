...
const DownloadButton: React.FC = () => {
  ...
  const downloadFile = () => {
    ...
    return (
      <button className="m-5 flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 active:scale-105 active:bg-blue-700 transition duration-100" onClick={ downloadFile }>
        <svg
